...
class Ui_TemplateConfigDialog(object):
    def setupUi(self, TemplateConfigDialog):
        ...
        TemplateConfigDialog.setFixedWidth(400)
        TemplateConfigDialog.setFixedHeight(300)
        #sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        #TemplateConfigDialog.setSizePolicy(sizePolicy)
        self.buttonBox = QtWidgets.QDialogButtonBox(TemplateConfigDialog)
        self.buttonBox.setGeometry(QtCore.QRect(310, 240, 81, 51))
        ...
        self.copyConfigButton.setGeometry(QtCore.QRect(10, 240, 291, 51))
